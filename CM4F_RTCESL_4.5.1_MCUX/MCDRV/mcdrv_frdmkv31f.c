...
void InitClock(void)
{
    ...
    g_sClockSetup.ui16M1PwmDeadTimePreScaler = 3U;
...
void InitFTM0(void)
{
    ...
    /* Dead time */
    //
    FTM0->DEADTIME =  (FTM_DEADTIME_DTPS(g_sClockSetup.ui16M1PwmDeadTimePreScaler) | FTM_DEADTIME_DTVAL(g_sClockSetup.ui16M1PwmDeadTime));
